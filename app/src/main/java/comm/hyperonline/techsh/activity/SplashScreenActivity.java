 ...
 */
public class SplashScreenActivity extends BaseActivity implements OnResponseListner {
...
//        goToNextPageAfterXSecond();

//        });

    }

    private void goToNextPageAfterXSecond() {
...
//        }
    ...
    public void homeOrIntroActivity() {
        ...
        if (getPreferences().getBoolean(RequestParamUtils.IS_INTRO_SHOWED, false)) {
