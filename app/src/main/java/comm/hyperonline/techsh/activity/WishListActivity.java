...
import comm.hyperonline.techsh.adapter.WishListAdapter;
...
//                Log.i("saaaaaaaaadsadasdsad", "getWishListData: " + new URLS().PRODUCT_URL + getPreferences().getString(RequestParamUtils.CurrencyText, ""));
    ...
    public void onResponse(String response, String methodName) {
        if (methodName.equals(RequestParamUtils.getWishListData)) {
            ...
            Log.i("Asdadadafafdsfsgs", "onResponse: " + response);
