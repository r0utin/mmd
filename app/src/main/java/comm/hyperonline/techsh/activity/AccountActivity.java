...
import comm.hyperonline.techsh.adapter.ChangeLanguageItemAdapter;
import comm.hyperonline.techsh.adapter.InfoPageAdapter;
import comm.hyperonline.techsh.adapter.WebPagesAdapter;
...
import comm.hyperonline.techsh.model.Customer;
import comm.hyperonline.techsh.model.InfoPages;
...
//            tvCustomerEmailLogin.setText(customer.email + "");
    ...
    @OnClick(R.id.tvWish)
    public void wish() {
        Intent wishListIntent = new Intent(AccountActivity.this, WishListActivity.class);
