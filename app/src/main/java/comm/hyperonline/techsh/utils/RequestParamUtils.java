...
public class RequestParamUtils {
    ...
    public static final String Tracking = "شماره پیگیری ";

    public static final String onHold = "on-hold";

    public static final String pending = "در حال بررسی";

    public static final String processing = "در حال پردازش";

    public static final String order = "سفارش";

    public static final String completed = "تکمیل شده";

    public static final String cancelled = "لغو شده";

    public static final String refunded = "عودت داده شده";
