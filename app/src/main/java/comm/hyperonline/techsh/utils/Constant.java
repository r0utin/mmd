...
import comm.hyperonline.techsh.model.Sort;
...
public class Constant {
    ...
    public static final String MyPREFERENCES = "comm.hyperonline.ciyashop"; // Add your package name

    public static final String PACKAGE_NAME = "comm.hyperonline.ciyashop";  // Add your package name
    ...
    public static final String MOBILE_COUNTRY_CODE = "+98"; // Add your mobile country Code

    public static final int DISTANCERANGE = 500;

    public static final String                 PRIMARY_COLOR                 = "#fc93ab";
    ...
    public static       String                 SECONDARY_COLOR               = "#fc93ab";
    ...
    public static       String                 HEAD_COLOR                    = "#fc93ab";
